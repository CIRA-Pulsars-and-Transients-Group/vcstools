...
dd if=../ch_100.dat of=7_100.dat bs=$size skip=70000 count=10000
dd if=../ch_100.dat of=8_100.dat bs=$size skip=80000 count=10000
...
$runner make_beam -S 100 -A 1 -e dat -v psrfits_header.txt -d $dir -n 128 -a 128 -r 10000 -o xx -w flags.txt -c phases.txt -t 1 -D $dir/../
dspsr -c 0.064 -L 0.1 -A -D 0.0 G0024_1118168248_01.hdr
