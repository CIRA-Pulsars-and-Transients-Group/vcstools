...
from process_vcs import getmeta,mdir
...
# TODO: need to figure out a way that we can smartly assess how much data is available (from metafits?). This is fine for online, but not so clear cut for offline products.
if req_data_len < 10:
