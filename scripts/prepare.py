...
def usage (opts={}):
    ...
    print "-r <J2000 RA>\n"
    print "-d <J2000 Dec>\n"
    print "-c [outdir] Submits the correlator job - does not get delays\n"
    ...
    print "-s Calibrator Info file (as generated by srclist_by_beam.py)"
    print "-i Input data directory: should contain calibrator fits files, array_file.txt and so on. Default = `pwd`"
...
if __name__ == '__main__':
    ...
    the_options = {'ra': "05:34:34", 'dec': "22:00:10", 'delays': False, 'submit': False, 'rts' : 0, 'rts_only' : 0, 'extn' : "pfb", 'mode' : 1,'metafile': "null", 'CalSrcFile': "null", 'data_dir': os.getcwd()}

    try:
        opts, args = getopt.getopt(sys.argv[1:],"hr:d:e:f:g:m:o:r:s:c:i:")
    ...
    if (the_options['rts_only'] == True):
        ...
        build_rts_in_file(obsid,utctime,the_options['data_dir'],rts_file)
        sys.exit(0)
