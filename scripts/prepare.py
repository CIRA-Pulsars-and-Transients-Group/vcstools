...
if __name__ == '__main__':
    ...
    the_options = {'ra': "05:34:34", 'dec': "22:00:10", 'delays': False, 'submit': False, 'rts' : 0, 'rts_only' : 0, 'extn' : "pfb", 'mode' : 1,'metafile': "null", 'CalSrcFile': "null"}

    try:
        opts, args = getopt.getopt(sys.argv[1:],"hr:d:e:f:g:m:o:r:s:c:")
